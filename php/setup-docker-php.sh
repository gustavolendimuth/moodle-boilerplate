...
curl -L https://raw.githubusercontent.com/gustavolendimuth/moodle-boilerplate/pazemente/php/Dockerfile -o Dockerfile

# Downloading the latest version of Docker Compose YAML file
curl -L https://raw.githubusercontent.com/gustavolendimuth/moodle-boilerplate/pazemente/php/docker-compose.yml -o docker-compose.yml
